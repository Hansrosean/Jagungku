...
import com.skripsi.jagungku.adapter.FilterSuhuUdaraAdapter.ViewHolder
import com.skripsi.jagungku.database.DataVarieties

class FilterPhTanahAdapter(
...
) : RecyclerView.Adapter<FilterPhTanahAdapter.ViewHolder>(), Filterable{
    ...
    class ViewHolder (itemView: View, clickListener: OnItemClickListener) : RecyclerView.ViewHolder(itemView) {
        val tvFilterNamaVarietas: TextView = itemView.findViewById(R.id.tv_filter_nama_varietas_in_ph_tanah)
        val tvFilterPhTanah: TextView = itemView.findViewById(R.id.tv_filter_ph_tanah_in_ph_tanah)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val itemView: View =
        LayoutInflater.from(parent.context).inflate(R.layout.data_ph_tanah_filter, parent, false)

        return ViewHolder(itemView, mListener)
    }

    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val getPhTanahFilter = dataVarietasFilter[position]

        val setText = getPhTanahFilter.phTanah.toString()
        holder.tvFilterNamaVarietas.text = getPhTanahFilter.namaVarietas
        holder.tvFilterPhTanah.text = "hingga $setText"
    }
            ...
            if (search.isEmpty()) {
                ...
                for (obj in dataVarietasBackup) {
                    ...
                    if (!filteredData.contains(obj) && obj.phTanah != 0.0) {
                        val getSuhuUdara: String = StringValue.of(obj.phTanah.toString()).toString()
